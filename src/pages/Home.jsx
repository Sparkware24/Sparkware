    ...
    <div>
      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mx-auto px-2 cursor-default">
          ...
          <div className="bg-white p-4 m-2 rounded shadow-lg max-w-[400px] transform transition-colors duration-300 hover:bg-blue-200 hover:border-blue-700 border border-transparent text-center">
            <img src={icon3} alt="Graphic Design" className="mx-auto mb-3 w-16" />
            <h2 className="text-2xl mb-2">Graphic Design</h2>
            <p className="text-lg">
              Sparkware creates impactful graphic designs that elevate your brand's visual identity. Our
              designs captivate your audience and convey your message effectively, using the latest trends and
              techniques.
            </p>
            <a
          ...
          <div className="bg-white p-4 m-2 rounded shadow-lg max-w-[400px] transform transition-colors duration-300 hover:bg-blue-200 hover:border-blue-700 border border-transparent text-center">
            <img src={icon4} alt="Software Maintenance and Support" className="mx-auto mb-3 w-16" />
            <h2 className="text-2xl mb-2">Software Maintenance and Support</h2>
            <p className="text-lg">
              Sparkware provides comprehensive software maintenance and support, including proactive
              monitoring, timely updates, and rapid issue resolution. We keep your systems efficient, secure,
              and up-to-date to ensure ongoing reliability and performance.
            </p>
            <a
          ...
          <div className="bg-white p-4 m-2 rounded shadow-lg max-w-[400px] transform transition-colors duration-300 hover:bg-blue-200 hover:border-blue-700 border border-transparent text-center">
            ...
            <p className="text-lg">
              Sparkware specializes in embedded system development, crafting custom solutions that enhance
