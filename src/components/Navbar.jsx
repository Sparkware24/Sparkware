...
const Navbar = () => {
  ...
  return (
    <nav className="bg-fuchasia-950 text-white py-4 px-10 fixed left-0 top-0 right-0 z-[1000]">
      ...
      {/* Side bar */}
      <div
        className={`fixed top-0 right-0 h-full overflow-y-auto bg-blue-800 text-white transform transition-transform duration-300 ${
